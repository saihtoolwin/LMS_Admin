        ...
        <div class="row filter-row">
            <div class="col-sm-6 col-md-3">
                <div class="form-group form-focus">
                    ...
                    <label class="focus-label">Academic year</label>
                </div>
            </div>
            <div class="col-sm-6 col-md-3">
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-right d-flex justify-content-end">
                                <a href="{{ route("academic.edit",$academic->id ) }}" class="btn btn-primary btn-sm mb-1 mr-2">
                                    <i class="far fa-edit"></i>
                                </a>

                                <a href="{{ route("academic.show",$academic->id ) }}" class="btn btn-primary btn-sm mb-1 mr-2">
                                    <i class="far fa-clone"></i>
                                </a>
                                
                                <form action="{{ route('academic.destroy', $academic->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this academic_year?')">
                                    @csrf
                                    @method('DELETE')
